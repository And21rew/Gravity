...
public class LoaderAssets {
    ...
    private void LoadSpritePlayer(GraphicsCore graphicsCore){
        ...
        UtilResource.spritePlayerBoost.add(graphicsCore.UpdateSprite(UtilResource.textureAtlas, 0, 64, 64, 64));
        UtilResource.spritePlayerBoost.add(graphicsCore.UpdateSprite(UtilResource.textureAtlas, 64, 64, 64, 64));
        UtilResource.spritePlayerBoost.add(graphicsCore.UpdateSprite(UtilResource.textureAtlas, 128, 64, 64, 64));
        UtilResource.spritePlayerBoost.add(graphicsCore.UpdateSprite(UtilResource.textureAtlas, 192, 64, 64, 64));
    }
}
